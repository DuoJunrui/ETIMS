...
import cn.duojunrui.etims.common.domain.ColumnDO;
import cn.duojunrui.etims.common.domain.TableDO;
...
public class GenUtils {
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        for (String template : templates) {
            ...
            try {
                ...
                throw new EtimsException("渲染模板失败，表名：" + tableDO.getTableName(), e);
            }
        }
    }
    ...
    public static Configuration getConfig() {
        try {
            ...
            throw new EtimsException("获取配置文件失败，", e);
        }
    }
